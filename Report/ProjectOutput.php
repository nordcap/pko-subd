...
print "<a href=\"../Graph/graphReport.php?Type=ProjectOutput\">График загрузки подразделений по месяцам</a><br />\n";
print "<CENTER><H2>Объектная карточка 'Утвержденные трудозатраты'</H2></CENTER><br />\n";
bodyProjectOutput("statusBVP");
